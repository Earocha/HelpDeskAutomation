...
export default class Main extends Component{
        ...
        return new Promise((resolve,reject)=>{
            ...
            this.podio.authenticateWithApp(this.fastlyAppId,this.fastlyAppToken, (response)=>{
                ...
                this.podio.isAuthenticated().then(() => {
                    ...
                    const newitem = this.podio.request('POST', `/item/app/${this.fastlyAppId}`, Fastly, function(response){console.log('Hey there', response)}).catch(err => console.log(err));
                    resolve(newitem);
    ...
    UpdateItemAmandaApp(Data,AmandaAppId){
        return new Promise((resolve,reject)=>{
            var SyncId = "";
            SyncId = Data[0].SyncItemId.toString();
            this.podio.authenticateWithApp(this.amandaAppId,this.amandaAppToken, (response)=>{
                ...
                this.podio.isAuthenticated().then(() => {
                    ...
                    const newitem = this.podio.request('PUT', `/item/${AmandaAppId}`, Amanda, function(response){console.log('Hey there', response);}).catch(err => console.log(err));
                    resolve(newitem);
    ...
    UpdateItemFastlyApp(Data,AmmandaId){
        return new Promise((resolve,reject)=>{
            var SyncId = "";
            SyncId = Data[0].SyncItemId.toString();
            this.podio.authenticateWithApp(this.fastlyAppId,this.fastlyAppToken, (response)=>{
                ...
                this.podio.isAuthenticated().then(() => {
                    ...
                    const newitem = this.podio.request('PUT', `/item/${Data[0].SyncItemId}`, Fastly, function(response){console.log('Hey there', response);}).catch(err => console.log(err));
                    resolve(newitem);
    ...
    CopyFileFastly(file_id){ //copy files to replace new file_id to update the item 
        return new Promise((resolve,reject)=>{
    ...
    FileUploadOnFastly(Data, AmmandaId,fileID){
        return new Promise((resolve,reject)=>{
            var SyncId = "";
            SyncId = AmmandaId.toString();
            this.podio.authenticateWithApp(this.fastlyAppId,this.fastlyAppToken, (error)=>{
                if (error) throw new Error(err);
                this.podio.isAuthenticated().then(() => {
                    var Fastly =  {
